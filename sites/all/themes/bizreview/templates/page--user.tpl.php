        ...
        <section class="<?php print $main_grid_class; ?>">
          ...
          <div id="main" class="clearfix">
            ...
            <div id="content-wrapper">
              <?php $user_title = user_load_by_name($variables['title']); ?>
              <?php print render($title_prefix); ?>
              <?php if ($title):?>
              <h1 class="page-title"><?php echo $user_title->field_business_organiser_name['und'][0]['value'] ? $user_title->field_business_organiser_name['und'][0]['value'] : $variables['title']; ?></h1>
              <?php endif; ?>
